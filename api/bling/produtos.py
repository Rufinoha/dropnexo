    ...
    *,
    ...
    cur.execute(
        ...
        SELECT pv.id, v.id, TRIM(v.sku),
               ...
               COALESCE(NULLIF(TRIM(v.ncm), ''), p.ncm),
               COALESCE(NULLIF(TRIM(v.gtin), ''), p.gtin),
               COALESCE(v.peso_liquido_kg, p.peso_liquido_kg),
               COALESCE(v.peso_bruto_kg, p.peso_bruto_kg),
