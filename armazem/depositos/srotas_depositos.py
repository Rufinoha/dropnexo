...
az_depositos_bp = Blueprint(
    "az_depositos",
    __name__,
    root_path=str(_MOD),
    template_folder="templates",
    static_folder="static",
    static_url_path="/static/armazem/depositos",
)


def init_app(app):
    app.register_blueprint(az_depositos_bp)
...
@az_depositos_bp.get("/armazem/depositos")
@login_obrigatorio()
@exigir_modulo(MODULO_ARMAZEM)
@exigir_permissao(codigo="az_depositos.ver")
def depositos():
    if (r := _exigir_armazem_tenant()) is not None:
        return r
    return render_template("frm_az_depositos.html", nav_ativo="az_depositos")



@az_depositos_bp.get("/armazem/depositos/dados")
@login_obrigatorio()
@exigir_modulo(MODULO_ARMAZEM)
def depositos_dados():
    if (r := _exigir_armazem_tenant()) is not None:
...
@az_depositos_bp.post("/armazem/depositos/apoio")
@login_obrigatorio()
@exigir_modulo(MODULO_ARMAZEM)
@exigir_permissao(codigo="az_depositos.editar")
def depositos_apoio():
    if (r := _exigir_armazem_tenant()) is not None:
        return r
    id_tenant = _id_tenant()
...
@az_depositos_bp.post("/armazem/depositos/salvar")
@login_obrigatorio()
@exigir_modulo(MODULO_ARMAZEM)
@exigir_permissao(codigo="az_depositos.editar")
...
@az_depositos_bp.post("/armazem/depositos/excluir")
@login_obrigatorio()
@exigir_modulo(MODULO_ARMAZEM)
@exigir_permissao(codigo="az_depositos.editar")
