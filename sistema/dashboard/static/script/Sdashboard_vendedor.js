(function () {
  ...
  const pedidosEl = document.getElementById("dash_vd_pedidos");
  ...
  function setKpis(k) {
    const map = {
      ...
      produtos: k.produtos_ativos ?? 0,
      forn: k.fornecedores_ativos ?? 0,
    };
